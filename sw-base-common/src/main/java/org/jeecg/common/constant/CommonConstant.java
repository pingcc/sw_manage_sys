...
public interface CommonConstant {
    ...
    public static String PREFIX_USER_SHIRO_CACHE =
        "shiro:cache:org.jeecg.modules.shiro.authc.ShiroRealm.authorizationCache:";
    /**
     * 登录用户Token令牌缓存KEY前缀
     */
    ...
    /**
     * 审批状态 draft 草稿，approval 审批中； refuse拒绝
     * stop 废弃 ALLOW 通过
     */
    public static final String FLOW_DRAFT = "DRAFT";
    public static final String FLOW_APPROVAL = "APPROVAL";
    public static final String FLOW_REFUSE = "REFUSE";
    public static final String FLOW_ALLOW = "ALLOW";
    public static final String FLOW_STOP = "STOP";

    /**
     * 审核业务功能类型 business_register，business_article_pub
     */
    public static final String BUSINESS_REGISTER = "business_register";
    public static final String BUSINESS_ARTICLE_PUB = "business_article_pub";
}
