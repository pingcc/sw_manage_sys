...
public interface ISysBaseAPI {
    ...
    List<LoginUser> getUserList(LoginUser loginUser);

    List<SysUserDepartInfoModel> getUserBySysDeparts(List<String> workNos);
     ...
     * 查询用户是否含有这些角色
     *
     * @param roleCodes 特定的职责
     * @return
     */
    boolean isUserContainRoles(String roleCodes);
    ...
    boolean isUserContainAllRoles(String roleCodes);
    ...
    /**
     * 根据部门SysDepart查询,当前和上级级所有部门信息
     * 可过滤信息字段
     *
     * @param sysDepart 过滤信息
     * @return
     */

    List<SysDepartModel> getSupDepart(SysDepartModel sysDepart);

    List<SysDepartModel> getDepartsByCode(SysDepartModel sysDepartModel);

    List<SysRoleModel> queryRoleList(SysRoleModel sysRoleModel);

    String getDepartNameByOrgCode(String orgCode);

    List<QuartzJobModel> findByJobClassName(String jobClassName);

    /**
     * 插入调度日志更新
     *
     * @param sysQuartzLogModel
     */
    void insertSysQuartzLog(SysQuartzLogModel sysQuartzLogModel);
     ...
     */
    void updateDepart(SysUserDepartVO sysUserDepartVO);
     ...
     * @return
     */
    String queryDepartCode(String code, String type);
     ...
     * @return
     */
    List<SysDepartGroupUserModel> querySysGroupUserList(List<String> orgCodes);
}
