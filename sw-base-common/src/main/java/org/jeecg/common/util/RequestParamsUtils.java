...
public class RequestParamsUtils {
    ...
    public static void validateJsonParams(JSONObject jsonObject, String... keys) throws IllegalArgumentException {
    ...
    public static void validateEntityFields(Object entity, String... fields) {
        if (fields != null && fields.length != 0) {
            if (entity == null) {
                throw new IllegalArgumentException("缺少对象信息: " + entity.getClass().getSimpleName());
            } else {
                String[] var2 = fields;
                ...
                for (int var4 = 0; var4 < var3; ++var4) {
                    ...
                    try {
                        ...
                        if (obj == null || obj instanceof String && "".equals(obj)) {
                            throw new IllegalArgumentException(entity.getClass().getSimpleName() + "对象，缺少参数 " + field);
                        }
    ...
    public static void validateEntityParams(Object entity, String... params) {
        ...
        validateJsonParams(jsonObject, params);
    }
