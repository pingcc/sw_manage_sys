            ...
            for (Field field : fields) {
                ...
                try {
                    ...
                    if ("isDeleted".equals(field.getName())) {
                        field.setAccessible(true);
                        Object local_isDeleted = field.get(parameter);
                        field.setAccessible(false);
                        if (local_isDeleted == null || local_isDeleted.equals("")) {
                            field.setAccessible(true);
                    ...
                    //注入所属业务平台
                    if ("sysBpOrgCode".equals(field.getName())) {
                        field.setAccessible(true);
                        Object local_sysBpOrgCode = field.get(parameter);
                        field.setAccessible(false);
                        if (local_sysBpOrgCode == null || local_sysBpOrgCode.equals("")) {
                            // 获取登录用户信息
                            if (sysUser != null) {
                                field.setAccessible(true);
                                field.set(parameter, sysUser.getBpOrgCode());
                                field.setAccessible(false);
                            }
                        }
                    }
