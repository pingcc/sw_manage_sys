...
public interface ISysDepartService extends IService<SysDepart> {
    ...
    List<SysDepart> getSupDepart(SysDepart sysDepart);

    /**
     * 根据部门编码查询所有部门
     */
    List<SysDepart> getDepartsByCode(SysDepart sysDepart);
    ...
    /**
     * 根据部门编码获取下级部门信息（含自己树形）
     *
     * @return
     */
    List<SysDepartTreeModel> queryTreeByOrgCode(String orgCode);
     ...
     * @return
     */
    List<SysUserDepartInfoVo> getUserBySysDeparts(@Param("userIds") List<String> userIds);
}
