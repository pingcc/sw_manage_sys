...
public interface SysUserMapper extends BaseMapper<SysUser> {
     ...
     * @return
     */
    List<SysUserDepVo> getDepFullNamesByUserIds(@Param("userIds") List<String> userIds);

    /**
     * 根据部门code,查询用户所属部门名称信息
     *
     * @param
     * @return
     */
    SysUserDepVo getDepFullNamesDepVo(@Param("orgCode") String orgCode);

    /**
     * 根据用户Ids,查询用户所属角色名称信息
     *
     * @param userIds
     * @return
     */
    List<SysUserRolesVo> getRoleNamesByUserIds(@Param("userIds") List<String> userIds);
    ...
    List<SysUserInfoRoleVo> queryUserInfoByRoleCode(Page<SysUserInfoRoleVo> page,
        @Param("roleCodes") List<String> roleCodes, @Param("orgCode") String orgCode,
        @Param("realname") String realname);

    List<SysUserVo> querySysDeptUserList(Page<SysUserVo> page, @Param(Constants.WRAPPER) Wrapper wrapper);
     ...
     * @param sysUser
     */
    void updateUserAvatar(@Param("sysUser") SysUser sysUser);
     ...
     * @return
     */
    List<SysDepartGroupUserVo> querySysGroupUserList(@Param("orgCodes") List<String> orgCodes);

    /**
     * 查询部门下面所有该角色下面所有的用户（去重）
     *
     * @param roleCodes
     * @param orgCode
     * @param realname
     * @return
     */
    List<SysDepartGroupUserVo> queryByGroupUserList(@Param("roleCodes") List<String> roleCodes,
        @Param("orgCode") String orgCode, @Param("realname") String realname);
