...
public class SysDepartPermissionController extends BaseSwController<SysDepartPermission, ISysDepartPermissionService> {
    @Autowired
    ...
    public Result<?> saveDeptRolePermission(@RequestBody JSONObject json) {
