...
public class SysMessageTemplateController extends BaseSwController<SysMessageTemplate, ISysMessageTemplateService> {
    @Autowired
    ...
    public Result<?> queryPageList(SysMessageTemplate sysMessageTemplate,
        ...
        QueryWrapper<SysMessageTemplate> queryWrapper =
            QueryGenerator.initQueryWrapper(sysMessageTemplate, req.getParameterMap());
    ...
    public Result<SysMessageTemplate> sendMessage(@RequestBody MsgParams msgParams) {
        ...
        boolean is_sendSuccess =
            pushMsgUtil.sendMessage(msgParams.getMsgType(), msgParams.getTemplateCode(), map, msgParams.getReceiver());
        if (is_sendSuccess) {
